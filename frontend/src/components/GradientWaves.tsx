// Ported from React Bits (https://reactbits.dev) -- a raymarched plasma-wave
// shader rendered via `ogl` (a minimal WebGL wrapper, not three.js). Replaces
// the earlier hand-built SVG wave layers with the actual requested component.
